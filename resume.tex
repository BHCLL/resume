...
\resheading{教育经历}
  \begin{itemize}[leftmargin=*]
    ...
    \item
      ...
      {\footnotesize
      \begin{itemize}
        % \item{专业课程: 计算智能, 最优化算法, 信息论基础, 数据分析, 最优控制理论, 数学分析, 高等代数, 泛函分析, 几何学, 数学建模, 概率统计, 近世代数, 实变函数, 数值分析, 数理方程, 应用模糊数学, 运筹学基础, 控制论基础, 复变函数, 常微分方程, 微分方程数值解 }
...
\resheading{项目经历}
  \begin{itemize}[leftmargin=*]
    \item
      \ressubheading{制造业产品设计服务与产业链协同技术研发与应用示范$\,$(国家支撑计划)}{前端开发}{汽车及零部件中小企业产业链协同平台}{2015.04 -- 2015.07}
      {\footnotesize
      \begin{itemize}
    ...
    \item
      \ressubheading{支撑区域和地方支柱产业的制造业信息化综合应用示范$\,$(国家支撑计划)}{前端开发}{四川省制造业信息化企业服务平台$\,$www.scmie.com.cn}{2015.04 -- 2015.07}
      {\footnotesize
      \begin{itemize}
...
\resheading{资格证书}
  \begin{itemize}[leftmargin=*]
    ...
    \item
      \ressubsingleline{全国大学英语}{四级，六级}{2010.06 -- 2011.12}
  \end{itemize}
...
\resheading{专业技能}
  \begin{itemize}[leftmargin=*]
    ...
    \item \textbf{项目/框架}: \href{http://www.bootcss.com/}{Bootstrap}，\href{https://jquery.com/}{jQuery}，\href{http://jeasyui.com/}{jQuery EasyUI}，less，\href{http://gulpjs.com/}{gulp}
